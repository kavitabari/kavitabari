...
--alter table  Author11 alter column Authorname varchar(100)
...
insert into book11 values (6,'kids book',104,700,'2020-9-13')
...
update  Author11 set Authorname = concat('Honourable',' ' , Authorname) where authorid in
(
select  authorid
from  book11 where  price>100
)

update  book11 set  price  =99 where authorid=100
select * from book11
select * from Author11

update  Author11 set Authorname ='ritika' where Authorid=100
update  Author11 set Authorname ='arun' where Authorid=101
update  Author11 set Authorname ='rina ' where Authorid=102
update  Author11 set Authorname ='vina ' where Authorid=103
update  Author11 set Authorname ='kavita' where Authorid=104
...
select a1.AwardName,count(b.Bookid) as ' Book count' from 
...
update book11  set price=price+(price*0.5) where bookid in 
(
select  
Bookid from Awards11 
) 
...
delete from Author11 where  Authorid   in(
select Authorid  from book11 where  Year (CAST( publisheddate as date) ) 
